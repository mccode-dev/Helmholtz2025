...
my $nodes = "1";
my $queue = "all";
my $MPImodule = "NVHPC/25.1-CUDA-12 OpenMPI/5.0.5";
my $runtime = 1;;
...
\n\nAfter running $0 NAME.batch is ready for submission using the sbatch command\n";
    ...
    print $OUT "#SBATCH --error=$name.stderr\n";
    print $OUT "#SBATCH --output=$name.stdout\n";
    print $OUT "#SBATCH --nodes $nodes\n";
    print $OUT "#SBATCH --partition $queue\n";
    print $OUT "#SBATCH -A training2508\n";
    ...
    print $OUT "export MCXTRACE=\$\{CONDA_PREFIX\}/share/mcxtrace/resources\n";
    print $OUT "module load ${MPImodule}\n";
    print $OUT "\n\n";
    print $OUT "### Set up mxrun line\n";
    print $OUT "mxrun --mpi=auto ";
